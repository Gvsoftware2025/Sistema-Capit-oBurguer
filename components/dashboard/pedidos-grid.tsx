...
export function PedidosGrid({ pedidos, onFinalizar, onAvancar, onClickDetalhes, onExcluir }: PedidosGridProps) {
  if (pedidos.length === 0) {
    return (
  ...
  return (
    <div className="flex-1 overflow-auto p-3 sm:p-4 lg:px-6 lg:py-5">
